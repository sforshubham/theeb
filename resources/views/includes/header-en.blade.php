                    ...
                    <div class="safeArea">
                        ...
                        <div class="headerCont">
                            ...
                            <div class="floatLeft ">
                                ...
                                <div class="rightCol">
                                    <div class="socialMediaIcons"><a href="https://ar-ar.facebook.com/theeb.rentacar" target="_blank" class="headFb"></a><a href="https://twitter.com/TheebRentACar" target="_blank" class="headTwitter"></a><a href="http://instagram.com/THEEBRENTACAR" target="_blank" class="headInsta"></a>Theeb Rent A Car</div>
                                    <div class="resNumb">
                                        خدمة العملاء: <bdo>920000572</bdo>
                                    </div>
                                </div>
                            </div>
                            <div class="clearBoth"></div>
                        </div>
                        <div class="posRelative mobileMenu">
                            <div class="mobileMenuBtnBg"><a class="mobileMenuBtn" href="javascript:;">القائمة</a></div>
                        </div>
                        <div class="headerNav">
                            <ul id="divHeader">
                                <li><a>Language</a> اللغة
                                    <div class="lanDD"><a href="/home" id="aArabic1">عربي</a><a href="/en/home" id="aEnglish1">English</a></div>
                                </li>
                                <div id="divNotLoggedn">
                                    <li><a href="javascript:;" id="aLogin"></a></li>
                                    <li><a href="javascript:;" id="aRegister"></a></li>
                                </div>
                            </ul>
                            <div class="clearBoth"></div>
                        </div>
            ...
            <nav id="site-navigation" class="main-navigation posRelative mobileMenu" role="navigation" aria-label="Top Menu">
                <div class="mainMenu">
                    <ul id="top-menu" class="menu">
                        ...
                        <li id="menu-item-n" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-n"><a href="{{ URL::to('/') }}">{{session()->has('user.IDNo') && session('user.FirstName') != '' ? session('user.FirstName') : 'User'}}</a>
                            <ul class="sub-menu">
